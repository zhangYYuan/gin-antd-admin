...
import findRoute, {
  getUrlQuery
} from "/Volumes/Java/Cloud/Golang/git_resources/gin-vue-admin/ClientSide/node_modules/umi-build-dev/lib/findRoute.js";
...
(() => {
  try {
    ...
    require("../../../node_modules/umi-plugin-ui/lib/bubble").default({
      port: 3000,
      path: "/Volumes/Java/Cloud/Golang/git_resources/gin-vue-admin/ClientSide",
      currentProject: "",
      isBigfish: undefined
    });
  } catch (e) {
